...
public class CalculateServiceServiceLocator extends org.apache.axis.client.Service implements com.cmcc.sunyiwei.CalculateServiceService {
    ...
    public com.cmcc.sunyiwei.CalculateService getCalculateService() throws javax.xml.rpc.ServiceException {
    ...
    public com.cmcc.sunyiwei.CalculateService getCalculateService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cmcc.sunyiwei.CalculateServiceSoapBindingStub _stub = new com.cmcc.sunyiwei.CalculateServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cmcc.sunyiwei.CalculateService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cmcc.sunyiwei.CalculateServiceSoapBindingStub _stub = new com.cmcc.sunyiwei.CalculateServiceSoapBindingStub(new java.net.URL(CalculateService_address), this);
                _stub.setPortName(getCalculateServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://sunyiwei.cmcc.com", "CalculateServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://sunyiwei.cmcc.com", "CalculateService"));
        }
